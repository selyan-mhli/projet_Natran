  ...
  return (
    <div className="space-y-6">
      <div className="glass-effect rounded-xl p-6">
        <h2 className="text-2xl font-bold text-white mb-2">Impact de la Solution</h2>
        <p className="text-slate-400 mb-6">
          Analyse comparative : Pyro-gazéification avec et sans tri intelligent par IA
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <ImpactCard
            ...
            title="Polluants"
            value="-65%"
            description="Réduction chlore, soufre, métaux"
            trend="down"
          />
          <ImpactCard
            icon={TrendingUp}
            title="Qualité Gaz"
            value="+42%"
            description="Amélioration pureté syngas"
            trend="up"
          />
          <ImpactCard
            icon={Leaf}
            title="Impact CO₂"
            value="-1200t"
            description="Tonnes CO₂ évitées/an"
            trend="down"
          />
          <ImpactCard
            icon={DollarSign}
            title="Économies"
            value="€450k"
            description="Par an (maintenance + qualité)"
            trend="up"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="glass-effect rounded-xl p-6">
          <h3 className="text-xl font-bold text-white mb-4">Réduction des Polluants (%)</h3>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={comparisonData}>
              ...
              />
              <Legend />
              <Bar dataKey="sansTri" fill="#ef4444" name="Sans Tri IA" radius={[8, 8, 0, 0]} />
              <Bar dataKey="avecTri" fill="#22c55e" name="Avec Tri IA" radius={[8, 8, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>

        <div className="glass-effect rounded-xl p-6">
          <h3 className="text-xl font-bold text-white mb-4">Évolution Qualité Gaz (Score/100)</h3>
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={gasQualityData}>
              ...
              />
              <Legend />
              <Line type="monotone" dataKey="sansTri" stroke="#ef4444" strokeWidth={2} name="Sans Tri IA" />
              <Line type="monotone" dataKey="avecTri" stroke="#22c55e" strokeWidth={2} name="Avec Tri IA" />
            </LineChart>
          </ResponsiveContainer>
        </div>
      </div>
      ...
      <div className="glass-effect rounded-xl p-6">
        <h3 className="text-xl font-bold text-white mb-4">Comparaison Performance Globale</h3>
        <div className="flex justify-center">
          <ResponsiveContainer width="100%" height={400}>
            <RadarChart data={performanceData}>
              ...
              <Radar name="Avec Tri IA" dataKey="A" stroke="#22c55e" fill="#22c55e" fillOpacity={0.3} />
              <Radar name="Sans Tri IA" dataKey="B" stroke="#ef4444" fill="#ef4444" fillOpacity={0.3} />
              <Legend />
            </RadarChart>
          </ResponsiveContainer>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="glass-effect rounded-xl p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-lg font-bold text-white">Efficacité Énergétique</h3>
          </div>
        ...
        <div className="glass-effect rounded-xl p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-lg font-bold text-white">Impact Environnemental</h3>
          </div>
          <div className="space-y-4">
        ...
        <div className="glass-effect rounded-xl p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-lg font-bold text-white">Économies Annuelles</h3>
          </div>
          <div className="space-y-4">
      ...
      <div className="glass-effect rounded-xl p-6 bg-gradient-to-br from-primary-900/20 to-primary-800/10 border border-primary-500/30">
        <h3 className="text-2xl font-bold text-white mb-4">Conclusion</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h4 className="text-lg font-semibold text-primary-300 mb-3">Bénéfices Techniques</h4>
          ...
          <div>
            <h4 className="text-lg font-semibold text-primary-300 mb-3">Bénéfices Économiques</h4>
            <ul className="space-y-2">
              <li className="flex items-start gap-2 text-slate-300">
                <span className="text-green-400 mt-1">✓</span>
  ...
  return (
    <div className="glass-effect rounded-xl p-6">
      <div className="flex items-center justify-between mb-3">
        <Icon className={`w-8 h-8 ${trend === 'up' ? 'text-green-400' : 'text-red-400'}`} />
